...
# Script shortcuts
SCRIPTMANAGER=$WRK/bin/2024-Chen_Benzonase-ChIP-exo/ScriptManager-v0.14.jar
RESIZE=$WRK/Fox_NFIA_CTCF/bin/resize_png.py

# Inputs and outputs
GENOME=$WRK/2024-Chen_Benzonase-ChIP-exo/hg19_files/hg19.fa
MOTIFS=$WRK/Fox_NFIA_CTCF/data/RefPT-Motif
