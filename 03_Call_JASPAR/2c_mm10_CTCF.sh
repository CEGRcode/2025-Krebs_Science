...
# Build mouse motif reference points from MPE-seq

# data/RefPT-JASPAR-nonK562
#   |--MA1929_1_mm10_intersected_MPE-seq10min_164bp_category1.bed
#   |--MA1929_1_mm10_intersected_MPE-seq10min_164bp_category2.bed
#   |--MA1929_1_mm10_intersected_MPE-seq10min_164bp_category3.bed
#   |--MA1929_1_mm10_intersected_MPE-seq10min_164bp_category4.bed
#   |--1000bp
#     |--MA1929_1_mm10_intersected_MPE-seq10min_164bp_category1_1000bp.bed
#     |--MA1929_1_mm10_intersected_MPE-seq10min_164bp_category2_1000bp.bed
#     |--MA1929_1_mm10_intersected_MPE-seq10min_164bp_category3_1000bp.bed
#     |--MA1929_1_mm10_intersected_MPE-seq10min_164bp_category4_1000bp.bed
...
BLACKLIST=../data/mm10_files/mm10_blacklist.bed
...
OUTDIR=FIMO/CTCF_MA1929.1_mm10

[[ -d $OUTDIR ]] || mkdir $OUTDIR

## FIMO CTCF motif agaist mm10 genome
fimo --verbosity 1 --thresh 1.0E-4 --max-strand --oc $OUTDIR ../data/JASPAR/CTCF_MA1929.1.meme $GENOME
...
gunzip -c NonK562_narrowPeaks/CTCF_J1_ENCFF533APC.bed.gz > $OUTDIR/ENCFF533APC.bed
#shuffle bedfiles
...
java -jar $SCRIPTMANAGER coordinate-manipulation expand-bed -c 164 $OUTDIR/MA1929_1_final_1000bp_intersected.bed -o $OUTDIR/MA1929_1_final_1000bp_intersected_164bp.bed
#do size selection so that nucleosomal fragments (126-185 bp) are pooled from DNAse_FLASH BAM file
samtools view -h data/BAM/MPE-seq_10min_merge_rep1_mm10.bam | awk 'BEGIN {OFS=t} /^@/ || ($9 >= 126 && $9 <= 185) || ($9 <= -126 && $9 >= -185)' | samtools view -b -o $OUTDIR/MPE-seq_10min_merge_rep1_mm10_126to185bp.bam
java -jar ../bin/picard.jar BuildBamIndex --INPUT $OUTDIR/MPE-seq_10min_merge_rep1_mm10_126to185bp.bam --OUTPUT $OUTDIR/MPE-seq_10min_merge_rep1_mm10_126to185bp.bam.bai
...
sed '1d' $OUTDIR/MPE-seq_10min_merge_rep1_mm10_126to185bp_MA1929_1_final_1000bp_intersected_164bp_combined_sum.tsv > $OUTDIR/MPE-seq_10min_merge_rep1_mm10_126to185bp_MA1929_1_final_1000bp_intersected_164bp_combined_sum_noHeader.tsv
...
## Split sorted sites into quartiles

#get number of rows for quartile splits
N_25=$(wc -l $OUTDIR/MA1929_1_final_1000bp_intersected_ratio.tsv | awk '{printf "%.f\n", $1 * 0.25}')
N_50=$(wc -l $OUTDIR/MA1929_1_final_1000bp_intersected_ratio.tsv | awk '{printf "%.f\n", $1 * 0.50}')
N_75=$(wc -l $OUTDIR/MA1929_1_final_1000bp_intersected_ratio.tsv | awk '{printf "%.f\n", $1 * 0.75}')

#take above motif dedup bedfile that is sorted by TSV.
head -n $N_25 $OUTDIR/MA1929_1_final_1000bp_intersected_ratio.tsv | cut -f1-6 > ../data/RefPT-JASPAR-nonK562/MA1929_1_mm10_intersected_MPE-seq10min_164bp_category1.bed
head -n $N_50 $OUTDIR/MA1929_1_final_1000bp_intersected_ratio.tsv | tail -n $N_25 | cut -f1-6 > ../data/RefPT-JASPAR-nonK562/MA1929_1_mm10_intersected_MPE-seq10min_164bp_category2.bed
head -n $N_75 $OUTDIR/MA1929_1_final_1000bp_intersected_ratio.tsv | tail -n $N_25 | cut -f1-6 > ../data/RefPT-JASPAR-nonK562/MA1929_1_mm10_intersected_MPE-seq10min_164bp_category3.bed
tail -n $N_25 $OUTDIR/MA1929_1_final_1000bp_intersected_ratio.tsv | cut -f1-6 > ../data/RefPT-JASPAR-nonK562/MA1929_1_mm10_intersected_MPE-seq10min_164bp_category4.bed

#expand bedfiles
java -jar $SCRIPTMANAGER coordinate-manipulation expand-bed -c 1000 ../data/RefPT-JASPAR-nonK562/MA1929_1_mm10_intersected_MPE-seq10min_164bp_category1.bed ../data/RefPT-JASPAR-nonK562/1000bp/MA1929_1_mm10_intersected_MPE-seq10min_164bp_category1_1000bp.bed
java -jar $SCRIPTMANAGER coordinate-manipulation expand-bed -c 1000 ../data/RefPT-JASPAR-nonK562/MA1929_1_mm10_intersected_MPE-seq10min_164bp_category2.bed ../data/RefPT-JASPAR-nonK562/1000bp/MA1929_1_mm10_intersected_MPE-seq10min_164bp_category2_1000bp.bed
java -jar $SCRIPTMANAGER coordinate-manipulation expand-bed -c 1000 ../data/RefPT-JASPAR-nonK562/MA1929_1_mm10_intersected_MPE-seq10min_164bp_category3.bed ../data/RefPT-JASPAR-nonK562/1000bp/MA1929_1_mm10_intersected_MPE-seq10min_164bp_category3_1000bp.bed
java -jar $SCRIPTMANAGER coordinate-manipulation expand-bed -c 1000 ../data/RefPT-JASPAR-nonK562/MA1929_1_mm10_intersected_MPE-seq10min_164bp_category4.bed ../data/RefPT-JASPAR-nonK562/1000bp/MA1929_1_mm10_intersected_MPE-seq10min_164bp_category4_1000bp.bed
