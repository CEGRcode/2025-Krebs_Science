...
NFIA1=$WRK/data/BAM/K562_NFIA_BX_rep1_hg38.bam
K562IgG=$WRK/data/BAM/K562_IgG_BX_merge_temp_hg38.bam
Input=$WRK/data/BAM/hg38_BAM/K562_-_BI_rep1_hg38.bam

NFIA=$WRK/Motif_analysis/NFIA
...
bedtools shift -i NFIA_Occupancy_1bp.bed -g $Genome -p 95 -m -95 > NFIA_Occupancy_down95bp.bed
bedtools shift -i NFIA_Occupancy_1bp.bed -g $Genome -p -95 -m 95 > NFIA_Occupancy_up95bp.bed
...
cat NFIA_Nuc_upstream_-_convert.bed NFIA_Nuc_upstream_+_convert.bed | bedtools shift -i - -p 1 -m -1 -g $Genome | cat - NFIA_engagedNuc_downstream.bed | \
...
paste "SCORES/NFIA_NFIA_Occupancy_down95bp_150bp_read1_MIN100_combined.cdt" -  > "SCORES/NFIA_NFIA_Occupancy_down95bp_150bp_up95bp_150bp_read1_combined.cdt"
...
4029 NFIA_Nuc_upstream_shuffled_temp.bed
3937 NFIA_Nuc_downstream_shuffled_temp.bed
...
cat NFIA_Nuc_upstream_shuffled_-_convert.bed NFIA_Nuc_upstream_shuffled_+_convert.bed | bedtools shift -i - -p 1 -m -1 -g $Genome | cat - NFIA_engagedNuc_shuffled_downstream.bed | \
...
bedtools shift -i NFIA_shuffled_downNuc.bed -g $Genome -p 95 -m -95 > NFIA_shuffled_downNuc_down95.bed
bedtools shift -i NFIA_shuffled_downNuc.bed -g $Genome -p -95 -m 95 > NFIA_shuffled_downNuc_up95.bed
...
tail -n +2 | cut -f 2-3 | \
paste "NFIA_shuffled_downNuc.bed" -  > NFIA_shuffled_downNuc_SCORES.bed
rm NFIA_shuffled_downNuc_down95.bed NFIA_shuffled_downNuc_up95.bed

bedtools shift -i NFIA_downNuc.bed -p 125 -m -125 -g $Genome > NFIA_downNuc_down125.bed
