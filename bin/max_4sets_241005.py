...
if __name__ == "__main__":
    if len(sys.argv) != 7:  # 4 input files + MASKED_region.tab + 1 output file + script name
        print("Usage: Python JOB.py input1.tab input2.tab input3.tab input4.tab MASKED_region.tab output.tab")
        sys.exit(1)

    input_files = sys.argv[1:5]  # First 4 arguments are input files
    masked_file = sys.argv[5]    # The 5th argument is the MASKED_region.tab file
    output_file = sys.argv[6]    # The 6th argument is the output file
