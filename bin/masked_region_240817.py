...
def calculate_boundaries(numeric_row_count, center_column=501):
    ...
    boundary_5_prime = center_column - distance_5_prime
    boundary_3_prime = center_column + distance_3_prime
